...
class DistributorController extends Controller
{
    ...
    {
        return Excel::download(new DistributorsExport, 'Laporan Distributor.xlsx');
    }

    public function exportPDF() 
    {
        return Excel::download(new DistributorsExport, 'Laporan Distributor.pdf', \Maatwebsite\Excel\Excel::DOMPDF);
    }
